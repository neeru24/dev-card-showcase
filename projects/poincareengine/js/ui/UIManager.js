import { CoordinateReadout } from './CoordinateReadout.js';
...
export class UIManager {
    constructor() {
        this.coord = new CoordinateReadout(document.getElementById('coord-readout'));
        this.fps = new FpsMonitor(document.getElementById('fps-monitor'));
        this.viewToggle = new ViewModeToggle(document.getElementById('view-toggle-btn'));
        this.debug = new DebugPanel(document.getElementById('debug-content'));
    }

    update(ship, dt) {
        this.coord.update(ship.body.position);
        this.fps.update(dt);
    }
}
...
/* Pad 61 */ /* Pad 62 */ /* Pad 63 */ /* Pad 64 */ /* Pad 65 */
