...
class BlobGenerator {
  ...
  setupEventListeners() {
    ...
    document.getElementById("speedSlider").addEventListener("input", (e) => {
      ...
      document.getElementById("speedValue").textContent =
        speedLabels[this.state.speed - 1];
  ...
  generateBlob() {
    ...
    for (let i = 0; i < complexity; i++) {
      ...
      const irregularRadius =
        radius * (1 - irregularity + Math.random() * irregularity * 2);
  ...
  generateRandomBlob() {
    ...
    document.getElementById("irregularitySlider").value =
      this.state.irregularity;
